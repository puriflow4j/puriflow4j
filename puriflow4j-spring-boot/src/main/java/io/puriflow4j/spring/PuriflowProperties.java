...
public class PuriflowProperties {
    ...
    public static class Logs {
        ...
        public List<String> getOnlyLoggers() { return onlyLoggers; }
        public void setOnlyLoggers(List<String> onlyLoggers) { this.onlyLoggers = onlyLoggers; }
        ...
        public List<String> getKeyAllowlist() { return keyAllowlist; }
        public void setKeyAllowlist(List<String> keyAllowlist) { this.keyAllowlist = keyAllowlist; }
        public List<String> getKeyBlocklist() { return keyBlocklist; }
        public void setKeyBlocklist(List<String> keyBlocklist) { this.keyBlocklist = keyBlocklist; }
    }

    public Mode getMode() { return mode; }
    public void setMode(Mode mode) { this.mode = mode; }

    public List<DetectorType> getDetectors() { return detectors; }
    public void setDetectors(List<DetectorType> detectors) { this.detectors = detectors; }
