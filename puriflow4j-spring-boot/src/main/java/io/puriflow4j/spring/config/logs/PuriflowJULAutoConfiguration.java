...
public class PuriflowJULAutoConfiguration {
    ...
    public Object puriflowJulInit(PuriflowProperties props, Sanitizer sanitizer, ExceptionClassifier classifier)
        ...
        new PuriflowJULInstaller(sanitizer, shortener, embedded, classifier, props.getMode()).install();
        return new Object();
    }
}
